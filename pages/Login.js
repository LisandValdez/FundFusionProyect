...
export default function Login() { 
    ...
    const handleEmailClick = () => {
        router.push('/LoginRegister'); // Cambiado a LoginRegister
    };
        ...
        <div className='loginDiv'>
            <div className='loginGrid'>
                ...
                <div className="loginButtons">
                    <button className="loginGoogle" onClick={handleGoogle}><GoogleIcon fontSize='medium'/>Seguir con Google</button>
